...
<body>
    ...
    <div class="about-me clearfix" id="about-me">
        <div class="container">
            <div class="row">
                <!-- Profile Pic -->
                <div class="my-pic center col-sm-4 col-xs-10 wow fadeInUpBig" data-wow-duration="0.5s" data-wow-offset="200">
                ...
                <div class="introduction col-sm-8 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-offset="200">
                    <h2 class="h2">SBS Tarun Reddy</h2>
                    <div class="heading-line"></div>
                    <p class="introduce">Programmer / web developer / public speaker</p>
                    <p class="intro">I am a 19-year-old Open Source enthusiast who writes code out of the profession and loves to engage in tech communities out of passion. While I have a comprehensive developer background, my emphasis is on scalability and innovation,
                        An articulate young individual looking for opportunities in Computing. </p>
                </div>
            </div>
            <div class="row">
                <div class="profile col-sm-4 col-xs-12 wow fadeInUp text-center" data-wow-duration="0.5s" data-wow-offset="200">
                    ...
                    <div class="personal-wrapper">
                        <span><strong>name: </strong>SBS Tarun Reddy</span>
                        <span><strong>E-mail:</strong>sbsatyatarunreddy@am.students.amrita.edu</span>
                        <span><strong>phone number: </strong>+91 7816027144</span>
                    </div>
                </div>
                <div class="why-me col-sm-8 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-offset="200">
                    ...
                    <div class="accordion">
                        <div class="acc-item">
                            ...
                            <div class="acc-content">Software Engineering fresher with the ability to offer quick and effective tech solutions to businesses that are highly-tech driven. Looking for a challenging startup-like environment that provides me with a good opportunity
                                for learning and advancement.</div>
                        </div>
                        <div class="acc-item">
                            <div class="acc-title"><i class="fa fa-plus"></i> My area of Strength.</div>
                            <div class="acc-content">I am proficient in C++,C,Python,Adobe Dev Tools(Acrobat DC). I am also good at public speaking and also took handful of workshops in fields i specialize.</div>
                        </div>
                        <div class="acc-item">
                        ...
                        <div class="acc-item">
                            ...
                            <div class="acc-content">In my free time I love to read about the new and upcoming technologies in open source and also explore the avaiable applications and the stacks they're built upon when i get some more time, i also love to roam around and observe
                                things around me. </div>
                        </div>
                    </div>
                    <!-- End Accordion -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="fact">
                        ...
                        <p id="number_">97.68</p>
                        <span style="font-size:25px"><b>SSC %(BSEAP)</b></span>
                    </div>
                </div>
                <!-- Fact No. 2 -->
                <div class="col-md-3 col-sm-6">
                    <div class="fact">
                        ...
                        <p id="number_2">73.20</p>
                        <span style="font-size:25px"><b>HSC %(BIEAP)</b></span>
                    </div>
                </div>
                <!-- Fact No. 3 -->
                <div class="col-md-3 col-sm-6">
                    <div class="fact">
                        ...
                        <p id="number_3">82.97</p>
                        <span style="font-size:25px"><b>B.TECH (CS)</b></span>
                    </div>
                </div>
                <!-- Fact No. 4 -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service">
                        ...
                        <p>I'm equipped with the abilities for website design and business solutions.</p>
                    </div>
                </div>
                <!-- Service No. 3 -->
                <div class="col-md-3 col-sm-6">
    ...
    <div class="technical-skills center" id="skills">
        ...
        <div class="container">
            ...
            <div class="skills-wrapper row">
                ...
                <!-- main skill No. 4 -->
                <div class="skill col-md-3 col-sm-6">
                    <div class="chart center" data-percent="50">
            ...
            <div class="other-skills">
                ...
                <div class="skills-wrapper row">
                    ...
                    <!-- Skill No. 4 -->
                    <div class='bar_group col-md-6 col-xs-12' data-max="100">
                        <div class=" bar_group__bar thick elastic" data-value="80" data-tooltip="true" data-label="Leadership" data-show-values="true" data-unit="%"></div>
                    </div>
                    <!-- Skill No. 5 -->
                    <div class='bar_group col-md-6 col-xs-12' data-max="100">
                        <div class=" bar_group__bar thick elastic" data-value="60" data-tooltip="true" data-label="planning" data-show-values="true" data-unit="%"></div>
                    </div>
                    <!-- Skill No. 6 -->
                    <div class='bar_group col-md-6 col-xs-12' data-max="100">
                    ...
                    <!-- Skill No. 7 -->
                    <div class='bar_group col-md-6 col-xs-12' data-max="100">
                        <div class=" bar_group__bar thick elastic" data-value="70" data-tooltip="true" data-label="Photoshop" data-show-values="true" data-unit="%"></div>
                    </div>
                    <!-- Skill No. 8 -->
                    <div class='bar_group col-md-6 col-xs-12' data-max="100">
                        <div class=" bar_group__bar thick elastic" data-value="50" data-tooltip="true" data-label="Cryptography" data-show-values="true" data-unit="%"></div>
                    </div>
                </div>
                <!-- End other skills -->
            </div>
    ...
    <div class="experiences center" id="experiences">
        <div class="container">
            ...
            <div class="title wow fadeIn" data-wow-duration="0.5s" data-wow-offset="200">
                ...
                <div class="heading-line"></div>
                <p class="main-para">I have got training from various reputed companies and institues where i learnt different skiil sets. </p>
            </div>
            <!-- start timeline -->
            <div class="timeline wow fadeIn" data-wow-duration="0.5s" data-wow-offset="200">
                ...
                <div class="timeline-block clearfix wow fadeInLeft" data-wow-duration="0.5s" data-wow-offset="200">
                    ...
                    <div class="content left round-corners">
                        ...
                        <span class="duration">( March 09 2020 : June 10 2020 )</span>
                        <span class="job-title">Ruby On Rails</span>
                        <p>I have done 3 month of specialization course from coursera ofeered by University of Michigan. The course was all about web development where a basic introduction to HTML5, CSS3, JavaScript, Bootstrap 4, and Responsive Web Design.</p>
                    </div>
                </div>
                <!-- Event No. 2 -->
                <div class="timeline-block clearfix wow fadeInRight" data-wow-duration="0.5s" data-wow-offset="200">
                    ...
                    <div class="content right round-corners">
                        ...
                        <span class="job-title"> Certified in Front-End Development</span>
                        <p>I started Learning About Web-Development and modern desktop and mobile application development</p>
                    </div>
                </div>
                <!-- Event No. 3 -->
                <div class="timeline-block clearfix wow fadeInRight" data-wow-duration="0.5s" data-wow-offset="200">
                    ...
                    <div class="content right round-corners">
                        ...
                        <span class="job-title">Certified By Climber institute of Online Learning</span>
                        <p>I completed my certification for UI/UX from Climber institute of Online Learning of the MyCaptain and also for database handling. </p>
                    </div>
                </div>
            </div>
            <!-- End Timeline -->
            ...
            <div class="row contact-info">
                <div class="col-md-3 col-sm-6 col-xs-12 info">
                    ...
                    <div class="info-content">
                        <h3>call me</h3>
                        <span>+91 7816027144</span>
                        <span>+91 6309535675</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 info">
                    ...
                    <div class="info-content">
                        ...
                        <span>reddytarunsbs321@gmail.com</span>
                        <span>sbsatyatarunreddy@am.students.amrita.edu</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 info">
                    ...
                    <div class="info-content">
                        <h3>Visit me</h3>
                        <span>Amritapuri,Kollam,Kerala</span><span>India</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 info">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12 links">
                        ...
                        <div class="icon-wrapper center">
                            <!-- Facebook Link -->
                            <a href="https://www.facebook.com/sbs.tarunreddy" class="icon fb" target="_blank">
                                <i class="fa fa-facebook"></i>
                                <i class="fa fa-facebook"></i>
                            </a>
                            <!-- instagram Link -->
                            <a href="https://www.instagram.com/vedavidvaan/" class="icon in" target="_blank">
                                <i class="fa fa-instagram"></i>
                                <i class="fa fa-instagram"></i>
                            </a>
                            <!-- Linkedin Link -->
                            <a href="https://www.linkedin.com/in/sbs-tarun-reddy-7799631a7" class="icon lin" target="_blank">
                    ...
                    <div class="col-md12 col-xs-12 copyright">
                        <h6>&copy; Made with &hearts; by SBS Tarun Reddy in 2020. All Rights Reserved.</h6>
                    </div>
                </div>
            </div>
        </div>
